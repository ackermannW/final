...
\begin{figure}[!ht]
    ...
    \begin{tikzpicture}
       ...
       \node[] at (4.2,4) (){$\beta$};
\end{tikzpicture}
\caption{Prikaz planarnog susreta}
\end{figure}
...
najopštiji slučaj vođenja. 
\begin{figure}[!ht]
    \centering
    \includegraphics[scale = 0.5]{3dProp.JPG}
...
sudara da se ne bi dobilo dojeljenje sa nulom, jer je tada udaljenost jednala nuli. 
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale = 0.35]{putanja3dProp.eps}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale = 0.7]{3dUbrzanja.eps}
...
očito da proporcionalna navigacija komanduje ubrzanaj koja garantuju susret sa metom, ali vođeni 
projektil neće uvijek biti u stanju postići ova ubrzanja i to je uzrok promašaja. U praksi, projektili 
često ne zadovoaljavaju zahtjevane performanse i upravo je zadatak autopilota da osigura zadovoljenje zadatih kriterija. 
%-----------------------
